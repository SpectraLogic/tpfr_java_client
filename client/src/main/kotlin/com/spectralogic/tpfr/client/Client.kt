...
interface Client {
     ...
     */
    fun indexFile(filePath: String): CompletableFuture<IndexStatus>
     ...
     * @return CompletableFuture<IndexStatus>
     */
    fun fileStatus(filePath: String): CompletableFuture<IndexStatus>
     ...
     * @return CompletableFuture<OffsetsStatus>
     */
    fun questionTimecode(params: QuestionTimecodeParams): CompletableFuture<OffsetsStatus>
     ...
     * @return CompletableFuture<ReWrapResponse>
     */
    fun reWrap(params: ReWrapParams): CompletableFuture<ReWrapResponse>
     ...
     * @return CompletableFuture<ReWrapStatus>
     */
    fun reWrapStatus(targetFileName: String): CompletableFuture<ReWrapStatus>
}