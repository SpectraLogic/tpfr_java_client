...
public interface Client {
     ...
     * @return @see {@link CompletableFuture<IndexStatus>}
     */
    CompletableFuture<IndexStatus> indexFile(final String filePath);
     ...
     * @return @see {@link CompletableFuture<IndexStatus>}
     */
    CompletableFuture<IndexStatus> fileStatus(final String filePath);
     ...
     * @return @see {@link CompletableFuture<OffsetsStatus>}
     */
    CompletableFuture<OffsetsStatus> questionTimecode(QuestionTimecodeParams params);
     ...
     * @return @see {@link CompletableFuture<ReWrapResponse>}
     */
    CompletableFuture<ReWrapResponse> reWrap(ReWrapParams params);
     ...
     * @return @see {@link CompletableFuture<ReWrapStatus>}
     */
    CompletableFuture<ReWrapStatus> reWrapStatus(final String targetFileName);
}
