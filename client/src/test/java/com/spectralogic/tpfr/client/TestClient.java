...
public class TestClient {
    ...
    public void successfulIndexFile() throws Exception {
        server.enqueue(new MockResponse()
                .setResponseCode(200)
                .setBody(ReadFileFromResources.INSTANCE.readFile("xml/index/SuccessfulIndexFileOrFileStatusCall.xml")));
    ...
    public void failedIndexFile() throws Exception {
        server.enqueue(new MockResponse()
                .setResponseCode(200)
                .setBody(ReadFileFromResources.INSTANCE.readFile("xml/index/FailedToIndex.xml")));
    ...
    public void fileStatusIndexing() throws Exception {
        server.enqueue(new MockResponse()
                .setResponseCode(200)
                .setBody(ReadFileFromResources.INSTANCE.readFile("xml/index/FileStatusIndexing.xml")));
    ...
    public void fileNotIndexedFileStatus() throws Exception {
        server.enqueue(new MockResponse()
                .setResponseCode(200)
                .setBody(ReadFileFromResources.INSTANCE.readFile("xml/index/FileStatusWhenFileNotIndexed.xml")));
    ...
    public void fileNotFoundFileStatus() throws Exception {
        server.enqueue(new MockResponse()
                .setResponseCode(200)
                .setBody(ReadFileFromResources.INSTANCE.readFile("xml/index/FileStatusWhenFileNotPresent.xml")));
    ...
    public void succeededQuestionTimecode() throws Exception {
        server.enqueue(new MockResponse()
                .setResponseCode(200)
                .setBody(ReadFileFromResources.INSTANCE.readFile("xml/fileOffset/GoodFileOffsetsCall.xml")));
    ...
    public void succeededQuestionTimecodeAskingForLastFrame() throws Exception {
        server.enqueue(new MockResponse()
                .setResponseCode(200)
                .setBody(ReadFileFromResources.INSTANCE.readFile("xml/fileOffset/GoodFileOffsetsCallAskingForLastFrame.xml")));
    ...
    public void fileNotFoundQuestionTimecode() throws Exception {
        server.enqueue(new MockResponse()
                .setResponseCode(200)
                .setBody(ReadFileFromResources.INSTANCE.readFile("xml/fileOffset/FileNotFoundOffsetsCall.xml")));
    ...
    public void reWrap() {
        ...
        testSource.forEach((k, v) -> {
            server.enqueue(new MockResponse()
                    .setResponseCode(200)
                    .setBody(ReadFileFromResources.INSTANCE.readFile("xml/reWrap/" + k)));
    ...
    public void reWrapStatus() {
        ...
        testSource.forEach((k, v) -> {
            server.enqueue(new MockResponse()
                    .setResponseCode(200)
                    .setBody(ReadFileFromResources.INSTANCE.readFile("xml/reWrapStatus/" + k)));
    ...
    public void reWrapError() throws Exception {
        server.enqueue(new MockResponse()
                .setResponseCode(200)
                .setBody(ReadFileFromResources.INSTANCE.readFile("xml/reWrapStatus/PartialFileStatusError.xml")));
